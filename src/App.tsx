            ...
            {currentView === "settings" && (
              ...
              >
                <SettingsSection
                  ...
                  onPhotoUpload={(entry, file) => void handleStaffPhotoUpload(entry, file)}
                  onPhotoRemove={(staffId) => void handleStaffPhotoRemove(staffId)}
            ...
            {currentView === "reports" && (
              ...
              >
                <ReportsSection
                  ...
                  onSyncKind={(kind) => handleSyncSheets(kind)}
