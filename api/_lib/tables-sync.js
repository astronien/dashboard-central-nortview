...
const mapSalesRow = (row, period) => {
  ...
  return {
    ...
    selling_price: pick(row, keysUsed[14]),
    bill_amount: pick(row, keysUsed[15]),
    quantity: pick(row, keysUsed[16]),
    customer_name: pick(row, keysUsed[17]),
