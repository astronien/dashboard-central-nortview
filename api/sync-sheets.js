...
function normalizeSheetRows(rows, kind) {
  ...
  return rows.map((r) => ({
    ...
    "Brand": r["Brand"] || r.brand || r.Brands || r["Brand Name"] || "",
    "Customer Code": r["Customer Code"] || r.customerCodes || r.customer_code || r.CustomerCode || r["Cust Code"] || "",
    "Model": r["Model"] || r.model || r.Models || r["Model Name"] || "",
    "Doc Type": r["Doc Type"] || r.doc_type || r.DocType || "",
    "Product Type": r["Product Type"] || r.product_type || r.ProductType || "Inventory Item",
