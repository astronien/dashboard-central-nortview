...
- กระชับที่สุด: แต่ละคนไม่เกิน 2-3 ประโยค เน้นจุดที่ต้องปรับ + สิ่งที่ควรทำ ตัดคำฟุ่มเฟือย/คำชมยาว ๆ ออก
- โครงสร้าง: (1) ภาพรวมทีม 1-2 บรรทัด (2) รายคน — จุดเด่นสั้น ๆ + จุดที่ต้องพัฒนา + สิ่งที่ควรทำพรุ่งนี้ (3) คนวิกฤติ ใส่แผนแก้เป็นข้อสั้น ๆ
- ต้องพูดถึงพนักงานทุกคนที่อยู่ในข้อมูล ห้ามข้ามหรือสรุปรวบคน
- คำศัพท์: UFUND = สินเชื่อบุคคลสำหรับลูกค้าที่ไม่มีบัตรเครดิต; COVER+/AC+ = ประกันเครื่อง; CSAT = ความพึงพอใจลูกค้า; BTB/BTB(Apple) = อุปกรณ์เสริมของ Apple (ไม่ใช่ดีลองค์กร)`;
